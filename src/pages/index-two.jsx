                ...
                <div className="grid lg:grid-cols-12 mt-10 md:grid-cols-2 gap-2">
                    <div className="lg:col-span-7">
                        ...
                        <div className="relative mt-10">
                            ...
                            <Link to="#" onClick={()=>setOpen(!isOpen)} className="size-12 inline-flex items-center text-center justify-center tracking-wide border align-middle duration-500 bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-full lightbox"><i className="mdi mdi-play text-xl align-middle"></i></Link><small className="text-white text-sm uppercase align-middle ms-2">Watch Now</small>
                        </div>
                    </div>
                            ...
                            <form>
                                <div className="grid grid-cols-1">
                                    <div className="mb-5">
                                        ...
                                        <input name="name" id="fName" type="text" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-primary/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none mt-2" placeholder="Name :" />
                                    </div>
                                    <div className="mb-5">
                                        <label className="dark:text-white">Email</label>
                                        <input name="email" id="yEmail" type="email" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-primary/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none mt-2" placeholder="Email :" />
                                    </div>
                                    <div className="mb-5">
                                        <label className="dark:text-white">Phone No.</label>
                                        <input name="number" id="phNumber" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-primary/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none mt-2" placeholder="+12 12458 854" />
                                    </div>
                                    <Link to="#" className="py-2 px-5 inline-block font-normal tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md w-full">Free Trial</Link>
                                </div>
                            </form>
