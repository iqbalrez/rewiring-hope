    ...
    return (
        <>
            <div>
                ...
                <section className="py-36 lg:py-48 w-full table relative overflow-hidden" id="home">
                    <div className="absolute inset-0  bg-top-left bg-cover" style={{backgroundImage:`url(${bg})`}}></div>
                            ...
                            <div className="lg:col-span-7 md:col-span-6">
                                <marquee className="max-w-3xs">
                                    <ul className="list-none">
                                        <li className="inline text-primary font-medium"><i className="mdi mdi-square-medium"></i> Creative solutions for everyone</li>
                                        <li className="inline text-primary font-medium"><i className="mdi mdi-square-medium"></i> Creative solutions for everyone</li>
                                        <li className="inline text-primary font-medium"><i className="mdi mdi-square-medium"></i> Creative solutions for everyone</li>
                                    </ul>
                                </marquee>

                                <h4 className="lg:text-6xl text-4xl lg:leading-normal leading-normal font-semibold mb-7 position-relative">Digital Agency Adventure in Marketing</h4>

                                <p className="text-slate-400 mb-0 max-w-2xl text-lg">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind CSS html page.</p>
                                ...
                                <div className="absolute flex justify-between items-center bottom-20 md:-start-10 -start-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-60 m-3">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xl font-medium"><CountUp className="counter-value" end="4589"/></p>
                                        </div>
                                    </div>
