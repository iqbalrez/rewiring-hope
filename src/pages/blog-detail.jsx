                    ...
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="sticky top-20">
                            ...
                            <div className="text-center mt-8">
                                <img src={client} className="h-24 w-24 mx-auto rounded-full shadow-sm mb-4" alt=""/>

                                <Link to="" className="text-lg font-medium hover:text-primary transition-all duration-500 ease-in-out h5">Cristina Romsey</Link>
                            ...
                            <ul className="list-none text-center mt-8 space-x-1">
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-dribbble align-middle"></i></Link></li>
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-behance align-middle"></i></Link></li>
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-linkedin align-middle"></i></Link></li>
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-facebook-f align-middle"></i></Link></li>
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-instagram align-middle"></i></Link></li>
                                <li className="inline"><Link to="" className="h-8 w-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-primary hover:text-white hover:bg-primary"><i className="uil uil-twitter align-middle"></i></Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
