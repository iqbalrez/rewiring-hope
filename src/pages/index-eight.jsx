            ...
            <div className="container relative z-1">
                <div className="grid grid-cols-1 mt-12">
                    ...
                    <div className="relative mt-10">
                        <Link2 to="#" className="py-2 px-5 inline-block font-normal tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md">Get Started</Link2>
                    </div>
                </div>
            </div>
