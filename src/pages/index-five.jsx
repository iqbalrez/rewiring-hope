...
export default function IndexFive() {
    return (
        <>
            ...
            <section className="py-36 md:h-auto md:py-0 flex items-center relative bg-primary/5 dark:bg-primary/10" id="home">
                        ...
                        <div className="mt-28">
                            <div>
                                ...
                                <div className="relative mt-10">
                                    <Link2 to="#" className="py-2 px-5 inline-block font-normal tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md">Start Free Trail !</Link2>
                                </div>
                            </div>
