...
export default function PricingAos() {
    const pricing = [
        {
            id: 1,
            title: 'Basic',
            ...
            <section className="relative md:py-24 py-16" id="pricing">
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center" data-aos="fade-up">
                        <h6 className="text-primary text-base font-medium uppercase mb-2">Pricing</h6>
                    ...
                    <div className="flex flex-wrap">
                        {pricing.map((item, key) => (
                            ...
                            <div className="w-full md:w-1/2 lg:w-1/3 px-0 md:px-3 mt-8" key={key} data-aos="fade-up" data-aos-delay={item.delay}>
                                <div
                                    className="flex flex-col pt-8 pb-8 bg-zinc-50 hover:bg-white dark:bg-gray-800 dark:hover:bg-slate-900 rounded-md shadow-sm shadow-slate-200 dark:shadow-slate-700 transition duration-500">
                                    <div className="px-8 pb-8">
                                        ...
                                        <Link to="#" className="py-2 px-5 inline-block font-normal tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md w-full">Started Now</Link>
                                    </div>
                    ...
                    <div className="flex justify-center text-slate-400 dark:text-slate-300 mt-2"><span className="text-primary">*</span>No credit card required</div>
                </div>
            </section>
