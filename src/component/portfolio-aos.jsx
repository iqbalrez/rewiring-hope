...
export default function PortfolioAos() {
    ...
    return (
        <>
                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
                        {projectList.map((item, index) => (
                            <div className="relative rounded-md shadow-xs overflow-hidden group" key={index} data-aos="fade-up" data-aos-delay={item.delay}>
            ...
            <section style={{ backgroundImage: `url(${CTABackground})` }} className="py-24 w-full table relative bg-center bg-cover">
