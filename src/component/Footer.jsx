...
export default function Footer() {
    ...
    return (
        <>
                    ...
                    <div className="grid md:grid-cols-12 items-center">
                        ...
                        <div className="md:col-span-4 md:mt-0 mt-8">
                            <ul className="list-none foot-icon md:text-end text-center">
                                ...
                                <li className="inline ms-1"><Link to="https://www.instagram.com/shreethemes/" target="_blank" className="size-8 inline-flex items-center text-center justify-center tracking-wide border align-middle duration-500 rounded-md border-slate-700 dark:border-slate-800 hover:border-primary bg-slate-800 dark:bg-gray-900 hover:bg-primary dark:hover:bg-primary text-gray-400 hover:text-white"><i className="uil uil-instagram align-middle" title="instagram"></i></Link></li>
                                <li className="inline ms-1"><Link to="https://twitter.com/shreethemes" target="_blank" className="size-8 inline-flex items-center text-center justify-center tracking-wide border align-middle duration-500 rounded-md border-slate-700 dark:border-slate-800 hover:border-primary bg-slate-800 dark:bg-gray-900 hover:bg-primary dark:hover:bg-primary text-gray-400 hover:text-white"><i className="uil uil-twitter align-middle" title="twitter"></i></Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            {/* <!-- Back to top --> */}
            <Link to="home" id="back-to-top" className="back-to-top fixed hidden text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-primary text-white leading-9"><i className="uil uil-arrow-up"></i></Link>
            {/* <!-- Back to top --> */}
        </>
    );
