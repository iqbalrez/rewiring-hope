...
export default function PortfolioAos() {
                ...
                <div className='content'>
                  <div className='icon absolute z-10 opacity-0 group-hover:opacity-100 top-4 end-4 transition-all duration-500'>
                    <Link
                      ...
                      className='size-9 inline-flex items-center text-center justify-center tracking-wide border align-middle duration-500 bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-full lightbox'
                    >
                  ...
                  <div className='absolute z-10 opacity-0 group-hover:opacity-100 bottom-4 start-4 transition-all duration-500'>
                    <Link
                      to='#'
                      className='h6 text-md font-medium text-white hover:text-primary transition duration-500'
                    >
                      {item.title}
                    </Link>
