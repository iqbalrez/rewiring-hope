        ...
        <div className='container'>
          ...
          <div className='flex flex-wrap'>
            {pricing.map((item, key) => (
              ...
              >
                <div className='flex flex-col pt-8 pb-8 bg-zinc-50 hover:bg-white dark:bg-gray-800 dark:hover:bg-slate-900 rounded-md shadow-sm shadow-slate-200 dark:shadow-slate-700 transition duration-500'>
