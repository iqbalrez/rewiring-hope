    ...
    <>
      ...
      <section className='relative md:py-24 py-16 active' id='features'>
        <div className='container lg mx-auto'>
          <div
            className='grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 pb-8 items-center'
            data-aos='fade-up'
            data-aos-delay='200'
          >
            <div>
          ...
          >
            {team.map((item, key) => (
              <div
                key={key}
                className={`features p-6 ${key % 2 === 0 ? 'hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-800' : 'shadow-xl shadow-slate-100 dark:shadow-slate-800'} transition duration-500 rounded-3xl mt-8`}
              >
                ...
                <div className='content mt-7'>
                  <Link
                    to='#'
                    className='text-lg hover:text-primary dark:text-white dark:hover:text-primary transition-all duration-500 ease-in-out font-medium'
                  >
                    {item.title}
                  </Link>
        ...
        <div className='container md:mt-24 mt-16'>
          ...
          <div className='grid grid-cols-1 mt-8'>
            <div className='timeline relative'>
              ...
              <div
                className='timeline-item mt-5 pt-4'
                data-aos='fade-up'
                data-aos-delay='600'
              >
                <div className='grid sm:grid-cols-2'>
